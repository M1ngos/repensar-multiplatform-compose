...
import { DependencyType } from '@/lib/api/types';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function AddDependencyDialog({ open, onOpenChange, taskId, onSuccess }: AddDependencyDialogProps) {
  ...
  const [dependencyType, setDependencyType] = useState<DependencyType>(DependencyType.FINISH_TO_START);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setDependencyType(DependencyType.FINISH_TO_START);
      ...
      <DialogContent>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={dependencyType} onValueChange={(value) => setDependencyType(value as unknown as DependencyType)}>
